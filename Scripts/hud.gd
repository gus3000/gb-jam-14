...
const MENU_LABEL_SETTINGS = preload("res://Resources/LabelSettings/menu_item.tres")
const FOCUS_LABEL_SETTINGS = preload("res://Resources/LabelSettings/menu_item_focus.tres")
